...
function TodosView:_init(bounds)
    ...
    self.quitButton = self:addSubview(ui.Button(ui.Bounds{size=ui.Size(0.12,0,0,0.05)}))
...
function TodosView:showNewTodoPopup(hand)
    local popup = ui.Surface(ui.Bounds{size=ui.Size(1,0.5,5.05)})

    local input = popup:addSubview(ui.TextField{bounds= ui.Bounds{size=ui.Size(0.8,0.1,0.05)}})

    local input = popup:addSubview(ui.TextField{bounds= ui.Bounds{size=ui.Size(0.8,0.1,0.05)}:move(0,0.15,0.025)})
    ...
    local addButton = 
    popup:addSubview(ui.Button(ui.Bounds{size=ui.Size(popup.bounds.size.width*0.8,0.1,0.05)}))
